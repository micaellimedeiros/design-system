var T=Object.defineProperty;var l=(t,a)=>T(t,"name",{value:a,configurable:!0});import{w as E,l as L,d as _,A as y,u as O,k as I}from"./iframe.7d5d1f29.js";var S="backgrounds",A;function P(t,a){return a||(a=t.slice(0)),Object.freeze(Object.defineProperties(t,{raw:{value:Object.freeze(a)}}))}l(P,"_taggedTemplateLiteral$1");var g=E.document,R=E.window,$=l(function(){var a=R.matchMedia("(prefers-reduced-motion: reduce)");return a.matches},"isReduceMotionEnabled"),H=l(function(a){var e=arguments.length>1&&arguments[1]!==void 0?arguments[1]:[],r=arguments.length>2?arguments[2]:void 0;if(a==="transparent")return"transparent";if(e.find(function(o){return o.value===a}))return a;var n=e.find(function(o){return o.name===r});if(n)return n.value;if(r){var d=e.map(function(o){return o.name}).join(", ");L.warn(_(A||(A=P([`
    ...
    `)},[i,p]);return O(function(){var v=e.viewMode==="docs"?"addon-backgrounds-docs-".concat(e.id):"addon-backgrounds-color";if(!s){j(v);return}D(v,f,e.viewMode==="docs"?e.id:null)},[s,f,e]),a()},"withBackground"),z;function K(t,a){return a||(a=t.slice(0)),Object.freeze(Object.defineProperties(t,{raw:{value:Object.freeze(a)}}))}l(K,"_taggedTemplateLiteral");var Y=I(function(){},_(z||(z=K([`
...
//# sourceMappingURL=preview.4221095f.js.map
